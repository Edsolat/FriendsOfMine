...
class ActiviteControllerSpec extends Specification {
    ...
    def populateValidParams(params) {
        ...
        params["titre"] = "rien faire"
        params["descriptif"] = "rien faire"

        //def unResponsable = new Utilisateur(nom : "ed", prenom: "edoudou", sexe: "M", email: "frgerger@fef.de")
        params["responsable.id"] = 1
        //def activiteInstance = new ActiviteService()
    }
